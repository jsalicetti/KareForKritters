        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-16">
            <div
              id="map"
              ref={mapRef}
              className="w-full md:w-2/3 h-[600px] border-2 border-gray-800 rounded-lg shadow-lg"
            ></div>
            <div className="w-full md:w-1/3">
              ...
              <p className="text-xl">
                Visit Kare for Kritters and meet our adorable animals waiting
                for their forever homes. Our facilities provide a safe and
                loving environment for pets in need.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="mb-4">
                In The Bronx, we offer a full-service animal shelter experience,
                including adoptions, surrenders and volunteers. We host adoption
                and fundraising events and offer a full range of services
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="mb-4">
                In Brooklyn, we provide a range of critically needed resources
                and services for cats and dogs. On-site cat and dog adoptions,
                surrenders, a pet food pantry, spay/neuter clinic along with a
                pet food and supplies pantry. As well as free medical
                care/vaccinations, foster care, and a meeting space for foster
                caregivers, volunteers and adopters.
              </p>
              <address className="font-bold">
                630 Flushing Avenue
                <br />
