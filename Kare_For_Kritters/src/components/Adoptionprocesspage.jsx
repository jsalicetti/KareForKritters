    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-400 to-blue-200 text-gray-800 font-sans">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <section className="flex flex-col md:flex-row items-center justify-between mb-16">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-base md:text-lg mb-6">
              We're excited to help you find your perfect furry friend. Our
              process is <br className="hidden md:inline" />
              designed to ensure the best match between pets and their new
              families.
            </p>

            <Link to="/pets" className="inline-block">
              <button className="bg-orange-600 text-white px-6 py-3 rounded-full hover:bg-orange-700 transition duration-300 transform hover:scale-105">
                View Adoptable Pets
              </button>
            </Link>
          </div>
          <div className="md:w-1/2">
            <img
              src="/Images-React/adoption-process.jpg"
        ...
        <section className="bg-white rounded-lg shadow-lg p-8 mb-16">
          ...
          <p className="mb-4">
            To adopt from us, you must meet the following criteria:
          </p>
              ...
              >
                ...
                <ChevronRightIcon
                  className={`w-6 h-6 transition-transform duration-300 ${
                    openStep === step ? "transform rotate-90" : ""
                  }`}
                />
              </button>
              {openStep === step && (
        ...
        <section className="flex flex-col md:flex-row justify-between items-center mb-16">
          <div className="md:w-[48%] mb-8 md:mb-0">
            <img
              src="/Images-React/application-image.jpg"
              alt="Adoption Image 1"
              className="rounded-lg shadow-xl w-full h-auto"
            />
          </div>
          <div className="md:w-[48%]">
            <img
              src="/Images-React/application-image2.jpg?height=400&width=600"
              alt="Adoption Image 2"
              className="rounded-lg shadow-xl w-full h-auto"
            />
          </div>
        </section>
