    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-400 to-blue-200 text-gray-800 font-sans">
      ...
      <main>
        <section className="relative h-[600px] overflow-hidden">
          <img
            src="/Images-React/dogherobackground.avif?height=600&width=1920"
            alt="Hero Image"
        ...
        <div className="container mx-auto px-4">
          <section className="flex flex-col md:flex-row justify-center gap-8 my-16">
            <div className="text-center">
              <img
                src="/Images-React/dogdonate.jpg"
                alt="Dog Donate"
                className="w-64 h-64 object-cover rounded-lg shadow-lg mb-4 transform hover:scale-105 transition duration-300"
              />
            ...
            <div className="text-center">
              <img
                src="/Images-React/catdonate.jpg"
                alt="Cat Donate"
                className="w-64 h-64 object-cover rounded-lg shadow-lg mb-4 transform hover:scale-105 transition duration-300"
              />
          ...
          <section className="text-center my-16 bg-white py-16 rounded-lg shadow-lg">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto px-4">
              With Kare for Kritters, you are working to save the lives of cats
              and dogs all across New York City, giving pets a second chance at
              ...
              {petStories.map((pet, index) => (
                ...
                >
                  ...
                  <div className="relative h-96">
                    ...
                    <div
                      className={`absolute inset-0 bg-white p-4 overflow-y-auto transition-opacity duration-300 ${
                        activeTab[index] === "info"
                          ? "opacity-100"
                          : "opacity-0"
                      }`}
                  ...
                  <div className="p-4">
                    <h3 className="text-xl font-semibold mb-1 text-orange-600">
                      {pet.name}
                    </h3>
